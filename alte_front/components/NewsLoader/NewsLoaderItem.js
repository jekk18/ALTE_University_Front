...
const NewsLoaderItem = (props) => {
  ...
  const [day, month, year] = [momentDate.date(), momentDate.month(), momentDate.year()];
  ...
  props?.coverImg[0]?.file ? (
    ...
    <img src="/img/defaultNews.png" alt="default" loading="lazy" />
        ...
        {momentDate.isValid() && <div className="event-time news-time">
