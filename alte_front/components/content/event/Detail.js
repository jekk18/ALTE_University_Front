                ...
                {locale == "ka" ? (
                  <>
                    {props.page.additional.start_date
                      ? `${geoStMonthName} ${st_day}, ${st_year} (${st_hour} : ${st_minute}) `
                      : null}
                    {props.page.additional.end_date
                      ? ` - ${geoStMonthName} ${end_day}, ${end_year} (${end_hour} : ${end_minute}) `
                      : null}
                  </>
                ) : (
                  <>
                    {props.page.additional.start_date
                      ? `${st_monthName} ${st_day}, ${st_year} (${st_hour} : ${st_minute}) `
                      : null}
                    {props.page.additional.end_date
                      ? ` - ${end_monthName} ${end_day}, ${end_year} (${end_hour} : ${end_minute}) `
                      : null}
                  </>
                )}
              </h2>
